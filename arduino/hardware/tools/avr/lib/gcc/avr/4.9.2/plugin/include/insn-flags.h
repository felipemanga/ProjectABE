...
#define HAVE_reload_inqi (reload_completed || reload_in_progress)
#define HAVE_reload_inqq (reload_completed || reload_in_progress)
#define HAVE_reload_inuqq (reload_completed || reload_in_progress)
#define HAVE_reload_inhi (reload_completed || reload_in_progress)
#define HAVE_reload_inhq (reload_completed || reload_in_progress)
#define HAVE_reload_inuhq (reload_completed || reload_in_progress)
#define HAVE_reload_inha (reload_completed || reload_in_progress)
#define HAVE_reload_inuha (reload_completed || reload_in_progress)
#define HAVE_reload_insi (reload_completed || reload_in_progress)
#define HAVE_reload_insq (reload_completed || reload_in_progress)
#define HAVE_reload_inusq (reload_completed || reload_in_progress)
#define HAVE_reload_insa (reload_completed || reload_in_progress)
#define HAVE_reload_inusa (reload_completed || reload_in_progress)
#define HAVE_reload_insf (reload_completed || reload_in_progress)
#define HAVE_reload_inpsi (reload_completed || reload_in_progress)
...
extern rtx        gen_reload_inqq                    (rtx, rtx, rtx);
extern rtx        gen_reload_inuqq                   (rtx, rtx, rtx);
extern rtx        gen_reload_inhi                    (rtx, rtx, rtx);
extern rtx        gen_reload_inhq                    (rtx, rtx, rtx);
extern rtx        gen_reload_inuhq                   (rtx, rtx, rtx);
extern rtx        gen_reload_inha                    (rtx, rtx, rtx);
extern rtx        gen_reload_inuha                   (rtx, rtx, rtx);
extern rtx        gen_reload_insi                    (rtx, rtx, rtx);
extern rtx        gen_reload_insq                    (rtx, rtx, rtx);
extern rtx        gen_reload_inusq                   (rtx, rtx, rtx);
extern rtx        gen_reload_insa                    (rtx, rtx, rtx);
extern rtx        gen_reload_inusa                   (rtx, rtx, rtx);
extern rtx        gen_reload_insf                    (rtx, rtx, rtx);
extern rtx        gen_reload_inpsi                   (rtx, rtx, rtx);
