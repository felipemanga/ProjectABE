...
#define ggc_alloc_avr_builtin_description() ((struct avr_builtin_description *)(ggc_internal_alloc_stat (sizeof (struct avr_builtin_description) MEM_STAT_INFO)))
#define ggc_alloc_cleared_avr_builtin_description() ((struct avr_builtin_description *)(ggc_internal_cleared_alloc_stat (sizeof (struct avr_builtin_description) MEM_STAT_INFO)))
#define ggc_alloc_vec_avr_builtin_description(n) ((struct avr_builtin_description *)(ggc_internal_vec_alloc_stat (sizeof (struct avr_builtin_description), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_avr_builtin_description(n) ((struct avr_builtin_description *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct avr_builtin_description), n MEM_STAT_INFO)))
